...
export default function Form3() {
    return (
        <>
            <div className="w-full pb-9  bg-[#000D19] pt-3.5 px-2.5  sm:px-10 ">
                <CustomProgressBar progress='95' fontColor="text-white"/>
                    <p className="mt-6 mb-2.5  text-white text-sm text-center sm:mt-5">
                        Eine Solaranlage spart Ihnen ca.
                    </p>
                    <p className="text-xl text-white text-center sm:text-lg">
                        30.000 - 35.000 € Stromkosten
                        <img
                            className="h-[15px] inline -mt-5 ml-2"
                            src='/svg/info.svg'
                            alt=""
                        />
                    </p>
